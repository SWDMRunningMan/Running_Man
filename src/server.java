		...
		public void run()  {
			try {
				...
				String msg = null;
					...
					if(str[0].equals("1")) {
						//ID, 이름,방이름, 전체인원, 술래수, 시간, 힌트
						R.make(str[1], Integer.valueOf(str[2]),str[3],Integer.valueOf(str[4]),Integer.valueOf(str[5]),Integer.valueOf(str[6]),Integer.valueOf(str[7]));
